...
public class DAO
{
    ...
    public void writeECPTTestPits()
    {
    	...
    	File layerfile = new File("/Users/markkahrl/ISSW2014_LayerData.csv");
    	File testfile = new File("/Users/markkahrl/ISSW2014_TestData.csv");
    	...
    	while ( e.hasMoreElements() )
    	{
            ...
            while ( tests.hasMoreElements())
            {
                    ...
                    if (score.equals("ECTP")) hasECPTTest=true;
